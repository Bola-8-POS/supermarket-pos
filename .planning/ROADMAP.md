...
- [x] 34-07-PLAN.md — Add `launchOptions.slowMo` to `playwright.tutorial.config.ts` for real per-action pacing inside bundled `narrate()` blocks, prove it on one spec, regenerate all 50 tutorial videos (VIDEO-01, VIDEO-04, VIDEO-05)
